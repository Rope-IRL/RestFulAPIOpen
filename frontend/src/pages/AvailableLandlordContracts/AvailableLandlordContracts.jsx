...
import styles from "./AvailableLandlordContracts.module.css"

function AvailableLandlordContracts() {
    ...
    const getProperty = async() => {
        const flatsRes = await fetch(`http://127.0.0.1:29180/api/flatcontract/landlord/filter`, {
            method: "GET",
            credentials: "include"
        })
        const housesRes = await fetch(`http://127.0.0.1:29180/api/housecontract/landlord/filter`, {
            method: "GET",
            credentials: "include"
        })
        const roomsRes = await fetch(`http://127.0.0.1:29180/api/roomcontract/landlord/filter`, {
            method: "GET",
            credentials: "include"
        })
...
export default AvailableLandlordContracts